...
/**
 * 解题思路
这道题首先给人的第一印象是一道二分查找的题目，但是使用二分查找的话会发现题目中是给了两个变量，也就是说你所能向下扔的鸡蛋的个数是有限制的。因此，这道题目便不是简单的二分查找的问题，而是一道动态规划的问题，而且是 dp 难问题。

既然是动态规划的题目，那么主要的解题思路便是寻找递推公式。
...
fun main() {
    println(Solution887().superEggDrop(2,3))
}